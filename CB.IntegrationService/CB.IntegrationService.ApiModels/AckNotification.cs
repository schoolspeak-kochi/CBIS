...
namespace CB.IntegrationService.ApiModels
{
    ...
    /// </summary>
    [DataContract]
    public partial class AckNotification :  IEquatable<AckNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public AckNotification(string AcknowledgeTimestamp = default(string), string RequestTimestamp = default(string), string EventToken = default(string), string StatusCode = default(string), string StatusMessage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AckNotification {\n");
        ...
        {
            return this.Equals(input as AckNotification);
        }

        /// <summary>
        /// Returns true if AckNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AckNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AckNotification input)
        {
            if (input == null)
                return false;
