...
namespace CB.IntegrationService.ApiModels
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegisterInstitutionResponse :  IEquatable<RegisterInstitutionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterInstitutionResponse" /> class.
        /// </summary>
        /// <param name="EBInstitutionId">Education Brands InstitutionId.</param>
        /// <param name="Services">Services.</param>
        public RegisterInstitutionResponse(string EBInstitutionId = default(string), List<ProductServices> Services = default(List<ProductServices>))
        {
        ...
        /// <summary>
        /// Education Brands InstitutionId
        /// </summary>
        /// <value>Education Brands InstitutionId</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegisterInstitutionResponse {\n");
        ...
        {
            return this.Equals(input as RegisterInstitutionResponse);
        }

        /// <summary>
        /// Returns true if RegisterInstitutionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterInstitutionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterInstitutionResponse input)
        {
            if (input == null)
                return false;
